...
object MysqlUtil {
  ...
  def main(args: Array[String]): Unit = {
    val list:  java.util.List[ JSONObject] = queryList("select * from Employee")
    println(list)
  }
  ...
  def   queryList(sql:String):java.util.List[JSONObject]={
    ...
    val conn: Connection = DriverManager
      .getConnection("jdbc:mysql://39.103.148.195:3306/play?characterEncoding=utf-8&useSSL=false","root","lovely0620")
